...
def new_login():
    ...
    image=ImageTk.PhotoImage(file="C:/Users/user/Pictures/bg2.jpg")
...
def forgot_ui():
    ...
    imgf=ImageTk.PhotoImage(file="D:/forgot.jpg")
...
def administration_portal():
    ...
    def admin_portal_orignal():
        ...
        but1_image=ImageTk.PhotoImage(file='C:/Users/user/Downloads/Group 6.png')
        ...
        add_book_butt=ImageTk.PhotoImage(file='C:/Users/user/Downloads/Group 1 (5).png')
        ...
        del_book_butt=ImageTk.PhotoImage(file='C:/Users/user/Downloads/Group 2.png')
        ...
        Update_book_butt=ImageTk.PhotoImage(file='C:/Users/user/Downloads/Group 3.png')
        ...
        see_orders_butt=ImageTk.PhotoImage(file='C:/Users/user/Downloads/Group 4.png')
        ...
        sales_butt=ImageTk.PhotoImage(file='C:/Users/user/Downloads/Group 5.png')
    ...
    lock_img=ImageTk.PhotoImage(file="D:/pngtree-lock-icon-for-your-project-png-image_5239757.jpg")
    ...
    Enter_Button=Button(admin_screen,text="Enter",width=12,fg="white",bg="Blue",font=('Microsoft Yahei UI light)',10,'bold'),command=Check_pass)
    Enter_Button.place(x=390,y=350)
...
def user_portal():
    ...
    main_image=ImageTk.PhotoImage(file="D:/Frame 1.png")
    
    Label(user_screen,image=main_image).pack()
    
    home_image=ImageTk.PhotoImage(file="D:/home.png")
    ...
    user_account_icon=ImageTk.PhotoImage(file="D:/user account icon.jpg")
    user_account_button=Button(user_screen,border=0,borderwidth=0,image=user_account_icon,bg="white")
    user_account_button.place(x=1140,y=190)
    
    user_cart_icon=ImageTk.PhotoImage(file="D:/shopping-cart.png")
    user_cart_butt=Button(user_screen,border=0,borderwidth=0,image=user_cart_icon,bg="white")
    user_cart_butt.place(x=1200,y=190)
    
    book_table_frame=Frame(user_screen,width=1000,height=400,bg='white',highlightbackground='red',highlightthickness=2)
    book_table_frame.place(x=0,y=250)
    scrool_x=Scrollbar(book_table_frame,orient=HORIZONTAL)    
    scrool_y=Scrollbar(book_table_frame,orient=VERTICAL)
    
    book_table=ttk.Treeview(book_table_frame,columns=("ID","BookName","Author_name","genre","Pulblihser_name","year","price"),yscrollcommand=scrool_y.set,selectmode="extended")
    
    

    
    #scrool_x.config(command=book_table.xview)
    scrool_y.config(command=book_table.yview)
    scrool_x.pack(side=BOTTOM,fill=X)
    scrool_y.pack(side=RIGHT,fill=Y)
    
    book_table.pack(expand=1,fill=BOTH)
    
    book_table.heading("ID",text="ISBN")
    book_table.heading("BookName",text="BOOKNAME")
    book_table.heading("Author_name",text="AUTHOR")
    book_table.heading("genre",text="GENRE")
    book_table.heading("Pulblihser_name",text="PUBLISHER")
    book_table.heading("year",text="YEAR")
    book_table.heading("price",text="PRICE")
    book_table.config(show="headings")
    
    #book_table.column("#0", width=0, stretch=NO)  # hide first column
    #book_table.column("ID", width=100, minwidth=100, anchor=CENTER)
    #book_table.column("BookName", width=200, minwidth=200, anchor=W)
    #book_table.column("Author_name", width=200, minwidth=200, anchor=W)
    #book_table.column("Pulblihser_name", width=200, minwidth=200, anchor=W)
    #book_table.column("year", width=100, minwidth=100, anchor=CENTER)
    #book_table.column("price", width=100, minwidth=100, anchor=CENTER)
...
def signin_screen()  :
      ...
      book_image=ImageTk.PhotoImage(file="C:/Users/user/Downloads/resize-1678907083105117588books.jpg")
      ...
      admin_image=ImageTk.PhotoImage(file="D:images.png")
      ...
      user_image=ImageTk.PhotoImage(file="D:/userimg.jpg")# jpg is not working
      ...
      team_img=ImageTk.PhotoImage(file="D:/mem.jpg")
...
img=PhotoImage(file="D:/login resize.png")
...
eyeimage=PhotoImage(file="D:\9883471.png")
